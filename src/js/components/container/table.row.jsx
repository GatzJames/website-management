        ...
        return (
            <div className="row wrapper">
                <div className="col-xs-12 first-data-row">
                    <div className="col-xs-1 col-sm-1" data-type="Id">{this.props.page.id}</div>
                    <div className="col-xs-12 col-sm-5" data-type="Title">{this.props.page.title}</div>
                    <div className="col-xs-6 col-sm-2" data-type="Type">{this.props.page.type}</div>
                    <div className="col-xs-6 col-sm-3" data-type="Published">{this.props.page.publishedOn}</div>
                    <div className="col-xs-1 col-sm-1" data-type="Status"><i className={statusClass}></i></div>
                </div>
